...
- `ThemeProvider` receives `selectedTheme` plus `initialColorScheme`, so the old switcher copy hydrates cleanly even when it reads the browser color-scheme text.
